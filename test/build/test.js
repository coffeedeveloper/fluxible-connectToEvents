...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fluxible = __webpack_require__(1);
	
	var _fluxible2 = _interopRequireDefault(_fluxible);
	
	var _fluxibleAddons = __webpack_require__(196);
	
	var _fluxibleAddonsReact = __webpack_require__(207);
	
	var _react = __webpack_require__(14);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _libMain = __webpack_require__(214);
	
	var _libMain2 = _interopRequireDefault(_libMain);
	
	// Action
	var action = function action(actionContext, payload) {
	  actionContext.dispatch('FOO_ACTION', payload);
	};
	
	// Store
	var FooStore = (0, _fluxibleAddons.createStore)({
	  storeName: 'FooStore',
	  handlers: {
	  ...
	  fooHandler: function fooHandler(payload) {
	    this.foo = payload;
	    this.emit('wa');
	  },
	...
	Test = (0, _libMain2['default'])(Test, [FooStore], {
	  'FooStore': {
	    'wa': 'handleWa'
	  }
	});
	
	Test = (0, _fluxibleAddonsReact.connectToStores)(Test, [FooStore], function (context, props) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(Test, { ref: 'test' })
	      );
	    }
	  }]);
	...
	App = (0, _fluxibleAddonsReact.provideContext)((0, _fluxibleAddonsReact.connectToStores)(App, [FooStore], function (context, props) {
	  return context.getStore(FooStore).getState();
	}));
	...
	context.executeAction(action, 'bar', function (err) {
	  _react2['default'].render((0, _fluxibleAddonsReact.createElementWithContext)(context), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fluxible = __webpack_require__(2);
	Fluxible.Fluxible = __webpack_require__(2);
	Fluxible.contextTypes = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(5)('Fluxible');
	var PromiseLib = global.Promise || __webpack_require__(8).Promise;
	var isPromise = __webpack_require__(12);
	var FluxibleContext = __webpack_require__(13);
	var dispatchr = __webpack_require__(191);
	...
	Fluxible.prototype.rehydrate = function rehydrate(obj, callback) {
	    ...
	    if (callback) {
	        rehydratePromise.then(function (contextValue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// noop
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(3).setImmediate, (function() { return this; }()), __webpack_require__(9)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(5)('Fluxible:Context');
	var isPromise = __webpack_require__(12);
	var PromiseLib = global.Promise || __webpack_require__(8).Promise;
	var React = __webpack_require__(14);
	var createElementWithContext = __webpack_require__(169);
	...
	FluxContext.prototype.createElement = function createElement(props) {
	    if (!warnedOnce && process.env.NODE_ENV !== 'production') {
	        console.warn('`context.createElement(props)` has been moved out of ' + 'Fluxible to fluxible-addons-react. This can be called using ' + '`require(\'fluxible-addons-react\').createElementWithContext(context, props)`');
	        warnedOnce = true;
	    }
	...
	FluxContext.prototype.executeAction = function executeAction(action, payload, done) {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	        if (this._dispatcher && this._dispatcher.currentAction) {
	            var currentActionDisplayName = this._dispatcher.currentAction.displayName || this._dispatcher.currentAction.name;
	
	            console.warn('Warning: executeAction for `' + displayName + '` was called, but `' + currentActionDisplayName + '` is currently being dispatched. This could mean ' + 'there are cascading updates, which should be avoided. `' + displayName + '` will only start after `' + currentActionDisplayName + '` is complete.');
	        }
	    }
	    ...
	    if (done) {
	        executeActionPromise.then(function (result) {
	            // Ensures that errors in callback are not swallowed by promise
	        ...
	        executeAction: function componentExecuteAction(action, payload, done) {
	            if (done) {
	                if ('production' !== process.env.NODE_ENV) {
	                    console.warn('When calling executeAction from a component,' + 'a callback isn\'t allowed. See our docs for more info:' + 'http://fluxible.io/api/components.html#component-context');
	                }
	            }
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(4), __webpack_require__(3).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(14);
	var FluxibleComponent = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(178));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(183));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(clearImmediate, process) {"use strict";
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3).clearImmediate, __webpack_require__(4)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Action = __webpack_require__(193);
	var DEFAULT = 'default';
	var DispatcherContext = __webpack_require__(194);
	...
	module.exports = {
	    createDispatcher: function createDispatcher(options) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	'use strict';
	var debug = __webpack_require__(5)('Dispatchr:Action');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Action = __webpack_require__(193);
	var DEFAULT = 'default';
	var debug = __webpack_require__(5)('Dispatchr:DispatcherContext');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    BaseStore: __webpack_require__(197),
	    createStore: __webpack_require__(201)
	};
	
	// Deprecated support
	var objectAssign = __webpack_require__(189);
	var movedMethods = {
	    connectToStores: __webpack_require__(203),
	    createElementWithContext: __webpack_require__(169),
	    FluxibleComponent: __webpack_require__(170),
	    FluxibleMixin: __webpack_require__(205),
	    provideContext: __webpack_require__(206)
	};
	if (process.env.NODE_ENV === 'production') {
	    ...
	    Object.keys(movedMethods).forEach(function (methodName) {
	        ...
	        Object.defineProperty(module.exports, methodName, {
	            get: function get() {
	                if (!warnedOnce) {
	                    console.warn('`' + methodName + '` has moved to the ' + '`fluxible-addons-react` package.');
	                    warnedOnce = true;
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(199);
	var BaseStore = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(14);
	var objectAssign = __webpack_require__(189);
	var hoistNonReactStatics = __webpack_require__(204);
	
	function createComponent(Component, stores, _getStateFromStores, customContextTypes) {
	    ...
	    var StoreConnector = React.createClass({
	        ...
	        getStateFromStores: function getStateFromStores(props) {
	            ...
	            if ('function' !== typeof _getStateFromStores) {
	                //@TODO remove this branch in next minor
	                if ('production' !== process.env.NODE_ENV) {
	                    console.warn('Using connectToStores with a state getter ' + 'map has been deprecated. Please use the new API as ' + 'documented at ' + 'http://fluxible.io/api/addons/connectToStores.html');
	                }
	                var state = {};
	                Object.keys(_getStateFromStores).forEach(function (storeName) {
	                    var stateGetter = _getStateFromStores[storeName];
	            ...
	            stores.forEach(function (store) {
	                ...
	                if ('production' !== process.env.NODE_ENV) {
	                    Object.defineProperty(storeInstances, storeName, {
	                        get: function get() {
	                            console.warn(componentName + '\'s connectToStores ' + 'state getter is trying to access ' + storeName + '. connectToStore no longer passes the ' + 'stores to the state getter. The state getter ' + 'signature is now (context, props) and you ' + 'should access the store using ' + '`context.getStore(' + storeName + ')`. See ' + 'https://github.com/yahoo/fluxible/pull/124 ' + 'for more details on this change.');
	            ...
	            return _getStateFromStores(mergedContext, props);
	...
	var FluxibleMixin = {
	    ...
	    executeAction: function executeAction() {
	        ...
	        if (!context || !context.executeAction) {
	            throw new Error('executeAction was called but no context was provided. Pass the fluxible' + 'context via a `context` prop or via React\'s context.');
	        }
	    ...
	    getStore: function getStore(store) {
	        ...
	        if ('object' !== typeof storeInstance) {
	            var context = this.props.context || this.context;
	            if (!context) {
	                throw new Error('storeListener mixin was called but no context was provided for getting the store.' + 'Pass the fluxible context via a `context` prop or via React\'s context.');
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    connectToStores: __webpack_require__(208),
	    createElementWithContext: __webpack_require__(210),
	    FluxibleComponent: __webpack_require__(211),
	    FluxibleMixin: __webpack_require__(212),
	    provideContext: __webpack_require__(213)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(14);
	var objectAssign = __webpack_require__(189);
	var hoistNonReactStatics = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(14);
	var FluxibleComponent = __webpack_require__(211);
	var objectAssign = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createComponent(Component, stores, events) {
	  ...
	  var EventConnector = React.createClass({
	    ...
	    render: function render() {
	      return React.createElement(Component, assign({}, { ref: 'component' }, this.props, this.state));
	    }
	  });
